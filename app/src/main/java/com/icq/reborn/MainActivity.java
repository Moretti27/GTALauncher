...
public class MainActivity extends Activity{
 ...
 public class Bridge{
  ...
  @JavascriptInterface public void prefSet(String key,String value){getSharedPreferences("icq_reborn",MODE_PRIVATE).edit().putString(key,value==null?"":value).commit();}
  @JavascriptInterface public void prefRemove(String key){getSharedPreferences("icq_reborn",MODE_PRIVATE).edit().remove(key).commit();}
