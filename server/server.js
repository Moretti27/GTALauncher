...
app.get('/health',(req,res)=>res.json({ok:true,name:'ICQ Reborn Server',version:'0.29.0'}));
...
server.listen(PORT,'0.0.0.0',()=>console.log('ICQ Reborn Server v0.29 on http://0.0.0.0:'+PORT));
